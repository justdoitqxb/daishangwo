    ...
    <body>
        <form action="index.jsp" method="post" name="form1" onsubmit="return checkForm(this);">
            <table align=center width=700 >
                <tr>
                    <td>
                       ISBN<input type="test" name="isbn" size="20" value="<%=isbn %>">
                       书名<input type="test" name="title" size="20" value="<%=title %>">
 ...
 <%
			...
			%>
                <tr>
                    <td ><%=(i+1) %></td>
                    <td ><%=model.getIsbn()%></td>
                    <td><a href="bookdetails.jsp?isbn=<%= model.getIsbn() %>" target="_blank"><%=model.getTitle()%></a></td>
